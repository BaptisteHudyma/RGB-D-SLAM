...
class Cylinder_Segment
{
  ...
  protected:
     ...
     * segments \param[in] planeNormals Normals of the planes to fit \param[in] projectedCentroids \param[in]
     * idsLeftMask container of the same size as idsLeft, indicating which ids are inliers \param[IFinal]
     *
