...
namespace poseEstimation {
    ...
    const Pose Pose_Utils::compute_right_camera_pose(const Pose& leftCamPose, double baseLine) {
    ...
    const matrix34 Pose_Utils::compute_world_to_camera_transform(const Pose& cameraPose) {
    ...
    const matrix34 Pose_Utils::compute_projection_matrix(const Pose& cameraPose, const matrix33& intrisics) {
    ...
    const vector2 Pose_Utils::project_point(const vector3& pt, const matrix34& projectionMatrix) {
