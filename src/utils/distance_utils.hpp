...
namespace rgbd_slam {
    namespace utils {
         ...
         */
        vector2 get_3D_to_2D_distance_2D(const vector3& worldPoint, const Eigen::VectorXd& cameraPoint, const matrix44& worldToCameraTransformationMatrix);
         ...
         */
        vector3 get_3D_to_3D_distance_3D(const vector3& worldPoint, const vector3& cameraPoint, const matrix44& cameraToWorldTransformationMatrix);
