...
\DoxyCodeLine{7 }
\DoxyCodeLine{8 \textcolor{preprocessor}{\#include "{}../../utils/coordinates.hpp"{}}}
\DoxyCodeLine{9 }
...
\DoxyCodeLine{100 }
\DoxyCodeLine{109                     \textcolor{keyword}{const} cv::Mat \mbox{\hyperlink{classrgbd__slam_1_1features_1_1keypoints_1_1_keypoint___handler_a4d2bd180c24ff535615eb91da77953b6}{compute\_key\_point\_mask}}(\textcolor{keyword}{const} \mbox{\hyperlink{structrgbd__slam_1_1utils_1_1_screen_coordinate}{utils::ScreenCoordinate}}\& pointToSearch, \textcolor{keyword}{const} std::vector<bool>\& isKeyPointMatchedContainer) \textcolor{keyword}{const};}
\DoxyCodeLine{110 }
...
\DoxyCodeLine{132                     std::vector<utils::ScreenCoordinate> \_keypoints;}
