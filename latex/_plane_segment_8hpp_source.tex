...
\label{_plane_segment_8hpp_source}\index{/home/baptou/Documents/code/robots/RGB\_SLAM/RGB-\/D-\/SLAM/src/features/PlaneSegment.hpp@{/home/baptou/Documents/code/robots/RGB\_SLAM/RGB-\/D-\/SLAM/src/features/PlaneSegment.hpp}}
...
\DoxyCodeLine{48 }
\DoxyCodeLine{54             \textcolor{keywordtype}{double} \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment_a853fa297a3ab3713f05a4cd8b98587b5}{get\_normal\_similarity}}(\textcolor{keyword}{const} \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment}{Plane\_Segment}}\& p);}
\DoxyCodeLine{55 }
\DoxyCodeLine{59             \textcolor{keywordtype}{double} \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment_ae10e911b47f794bcb4bec7d7db0364bf}{get\_signed\_distance}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double} point[3]);}
\DoxyCodeLine{60 }
\DoxyCodeLine{64             \textcolor{keywordtype}{double} \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment_ae10e911b47f794bcb4bec7d7db0364bf}{get\_signed\_distance}}(\textcolor{keyword}{const} Eigen::Vector3d\& point);}
\DoxyCodeLine{65 }
...
\DoxyCodeLine{80                 \textcolor{keyword}{const} Eigen::Vector3d\& \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment_adfbe8b62694d191d712bbe9587839c15}{get\_normal}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \_normal; \};}
\DoxyCodeLine{81                 \textcolor{keyword}{const} Eigen::Vector3d\& \mbox{\hyperlink{classrgbd__slam_1_1features_1_1primitives_1_1_plane___segment_a1fe700573282a68b77d6a2522a475839}{get\_mean}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \_mean; \};}
...
\DoxyCodeLine{99 }
\DoxyCodeLine{100                 Eigen::Vector3d \_mean;     \textcolor{comment}{//mean point of all points in node}}
\DoxyCodeLine{101                 Eigen::Vector3d \_normal;   \textcolor{comment}{//fitted plane normal}}
