...
\DoxyCodeLine{65 }
\DoxyCodeLine{71                 \textcolor{keyword}{const} \mbox{\hyperlink{structrgbd__slam_1_1features_1_1keypoints_1_1_keypoints_with_id_struct}{features::keypoints::KeypointsWithIdStruct}} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_a8e0a9d1f902a90b99b39e90dbd63cb73}{get\_tracked\_keypoints\_features}}() \textcolor{keyword}{const};}
\DoxyCodeLine{72 }
\DoxyCodeLine{76                 \textcolor{keywordtype}{void} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_ad1073f3d16e8549024d939620831cc1e}{reset}}();}
\DoxyCodeLine{77 }
\DoxyCodeLine{78 }
...
\DoxyCodeLine{90 }
\DoxyCodeLine{91                 \textcolor{comment}{// Define types}}
\DoxyCodeLine{92 }
\DoxyCodeLine{93                 \textcolor{comment}{// local map point container}}
\DoxyCodeLine{94                 \textcolor{keyword}{typedef} std::map<size\_t, Map\_Point> \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_adba0ccb456215900a47b062474ed222e}{point\_map\_container}};}
\DoxyCodeLine{95                 \textcolor{comment}{// staged points container}}
\DoxyCodeLine{96                 \textcolor{keyword}{typedef} std::map<size\_t, Staged\_Point> \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_ad8c094b7bffa2aca41064e1260227d2b}{staged\_point\_container}};}
\DoxyCodeLine{97                 \textcolor{comment}{// local shape primitive map container}}
\DoxyCodeLine{98                 \textcolor{keyword}{typedef} std::map<size\_t, Primitive> \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_a7e3162059a4ff3d0d879a856bd0a0a14}{primitive\_map\_container}}; }
\DoxyCodeLine{99 }
\DoxyCodeLine{100 }
...
\DoxyCodeLine{168 }
\DoxyCodeLine{172                 \textcolor{keywordtype}{void} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_af62ebdf2d7be0eca02c759a8cc1ea602}{update\_local\_to\_global}}();}
\DoxyCodeLine{173 }
\DoxyCodeLine{174 }
...
\DoxyCodeLine{193 }
\DoxyCodeLine{201                 \textcolor{keywordtype}{bool} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_a2c95f09e7fc79f6d22ccbb0d5303a76f}{mark\_point\_with\_id\_as\_unmatched}}(\textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} pointId);}
\DoxyCodeLine{202 }
...
\DoxyCodeLine{209                 \textcolor{comment}{// Local map contains world points with a good confidence}}
\DoxyCodeLine{210                 \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_adba0ccb456215900a47b062474ed222e}{point\_map\_container}} \_localPointMap;}
\DoxyCodeLine{211                 \textcolor{comment}{// Staged points are potential new map points, waiting to confirm confidence}}
\DoxyCodeLine{212                 \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_ad8c094b7bffa2aca41064e1260227d2b}{staged\_point\_container}} \_stagedPoints;}
\DoxyCodeLine{213                 \textcolor{comment}{// Hold unmatched detected point indexes, to add in the staged point container}}
\DoxyCodeLine{214                 std::vector<bool> \_isPointMatched;}
\DoxyCodeLine{215                 \textcolor{comment}{// Hold unmatched primitive ids}}
\DoxyCodeLine{216                 std::set<uchar> \_unmatchedPrimitiveIds;}
\DoxyCodeLine{217 }
\DoxyCodeLine{218                 \textcolor{comment}{//local primitive map}}
\DoxyCodeLine{219                 \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_a7e3162059a4ff3d0d879a856bd0a0a14}{primitive\_map\_container}} \_localPrimitiveMap;}
\DoxyCodeLine{220                 std::unordered\_map<int, uint> \_previousPrimitiveAssociation;}
\DoxyCodeLine{221 }
\DoxyCodeLine{222                 \mbox{\hyperlink{classrgbd__slam_1_1outputs_1_1_x_y_z___map___writer}{outputs::XYZ\_Map\_Writer}}* \_mapWriter; }
\DoxyCodeLine{223 }
\DoxyCodeLine{224                 \textcolor{comment}{// Remove copy operators}}
\DoxyCodeLine{225                 \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map_a55f49d47df2e5c63d581786b64645ee6}{Local\_Map}}(\textcolor{keyword}{const} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map}{Local\_Map}}\& map) = \textcolor{keyword}{delete};}
\DoxyCodeLine{226                 \textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} \mbox{\hyperlink{classrgbd__slam_1_1map__management_1_1_local___map}{Local\_Map}}\& map) = \textcolor{keyword}{delete};}
\DoxyCodeLine{227         \};}
\DoxyCodeLine{228 }
\DoxyCodeLine{229     \}}
\DoxyCodeLine{230 \}}
